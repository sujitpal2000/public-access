...
```
npm create cloudflare@latest -- --template=cloudflare/templates/public-access
```

A live public deployment of this template is available at [https://public-access.templates.workers.dev](https://public-access.templates.workers.dev)
